...
require_once __DIR__ . "/../forwarditerator/StackForwardIterator.php";
require_once __DIR__ . "/../forwarditerator/ForwardIterable.php";

class Stack implements \ForwardIterable {
  ...
  public function to_iterator(): \StackForwardIterator {
    return new \StackForwardIterator($this->elements);
  }
}