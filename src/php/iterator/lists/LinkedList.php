...
require_once __DIR__ . "/../forwarditerator/LinkedListForwardIterator.php";
require_once __DIR__ . "/../forwarditerator/ForwardIterable.php";
...
class LinkedList implements \ForwardIterable {
  ...
  public function to_iterator(): \LinkedListForwardIterator {
    return new \LinkedListForwardIterator($this->_head);
  }
}