...
require_once __DIR__ . "/../forwarditerator/BinarySearchTreeForwardIterator.php";
...
class BinarySearchTree implements \ForwardIterable {
  ...
  public function to_iterator(): \BinarySearchTreeForwardIterator {
    return new \BinarySearchTreeForwardIterator($this);
  }
}